                    ...
                    <div class="widget-content nopadding">
                        ...
                        <form name="form1" action="" method="post" class="form-horizontal">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span11" name="assettag" value="<?php echo isset($ssd['ssd_assettag']) ? $ssd['ssd_assettag'] : 'None'; ?>" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Brand :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="brand" value="<?php echo isset($ssd['ssd_brand']) ? $ssd['ssd_brand'] : 'None'; ?>" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Model Number :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="modelnumber" value="<?php echo isset($ssd['ssd_modelnumber']) ? $ssd['ssd_modelnumber'] : 'None'; ?>" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Size :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="size" value="<?php echo isset($ssd['ssd_size']) ? $ssd['ssd_size'] : 'None'; ?>" required />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Date Acquired :</label>
                                <div class="controls">
                                    <input type="date" class="span11" name="dateacquired" value="<?php echo isset($ssd['ssd_dateacquired']) ? $ssd['ssd_dateacquired'] : 'None'; ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Device Age :</label>
                                <div class="controls">
                                    <input type="number" class="span11" name="deviceage" value="<?php echo isset($ssd['ssd_deviceage']) ? $ssd['ssd_deviceage'] : 'None'; ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Assigned User :</label>
                                <div class="controls">
                                    <input type="text" class="span11" name="assigneduser" value="<?php echo isset($ssd['ssd_assigneduser']) ? $ssd['ssd_assigneduser'] : 'None'; ?>" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Remarks :</label>
                                <div class="controls">
                                    <textarea class="span11" name="remarks"><?php echo isset($ssd['ssd_remarks']) ? $ssd['ssd_remarks'] : 'None'; ?></textarea>
                                </div>
                            </div>
                            ...
                            <table class="table table-bordered table-striped" style="min-width: 1200px;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo !empty($ssd['ssd_assettag']) ? htmlspecialchars($ssd['ssd_assettag']) : 'None'; ?></td>
